							...
							<div class="portlet box light-grey">
								...
								<div class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												<th class="hidden-480">申报单位</th>
												<th class="hidden-480">用工时间</th>
												<th class="hidden-480">缓急程度</th>
												<th class="hidden-480">施工班组</th>
												<th class="hidden-480">施工设备</th>
										...
										<tbody>
											<c:forEach var="invoice" items="${invoices}">
												<tr class="odd gradeX">
													<td class="hidden-480">${invoice.unit}</td>
													<td class="hidden-480">${invoice.date}</td>
													<td class="hidden-480">${invoice.isDelay}</td>
													<td class="hidden-480">${invoice.group}</td>
													<td class="hidden-480">${invoice.device}</td>
													<td><span class="label label-reverse">未审核</span></td>
												</tr>
