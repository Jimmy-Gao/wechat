	...
	<div class="page-container">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class=" "><a href="/"> <i class="icon-home"></i> <span
						class="title">菜单面板</span> <span class="selected"></span>

				</a></li>

				<li class="start active"><a href="javascript:;"> <i
						class="icon-cogs"></i> <span class="title">工单管理</span> <span
						class="arrow "></span>
				</a>
					<ul class="sub-menu">
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-body form">
								...
								<form action="/addInvoice" class="form-horizontal"
									class="span12" method="post">
									<table class="span12">

										<tr class="">
											<td><label>申报单位</label></td>
											<td><input type="text" class="span12 m-wrap" name="unit"
												value="${user}" readonly /></td>
											<td><label>用工时间</label></td>
											<td><select class="span12 m-wrap"
												data-placeholder="选择用工时间" tabindex="1" name="date">
													<option value="今天">今天</option>
													<option value="明天">明天</option>
											</select></td>
											<td><label>缓急程度</label></td>
											<td><select class="span12 m-wrap"
												data-placeholder="选择缓急程度" tabindex="1" name="isDelay">
													<option value="可缓">可缓</option>
													<option value="不可缓">不可缓</option>
											</select></td>
										</tr>
										<tr class="">
											<td><label>施工位置</label></td>
											<td><input type="text" class="span12 m-wrap"
												name="position" /></td>
											<td><label>施工班组</label></td>
											<td><select class="span12 m-wrap"
												data-placeholder="选择施工班组" tabindex="1" name="group">
													<option value="机修班">机修班</option>
													<option value="电工班">电工班</option>
													<option value="泵修班">泵修班</option>
													<option value="管焊班">管焊班</option>
													<option value="其它">其它</option>
											</select></td>
											<td><label>选择班组</label></td>
											<td><select class="span12 m-wrap"
												data-placeholder="选择班组" tabindex="1" name="team">
										...
										<tr class="">
											...
											<td><select class="span3 m-wrap" name="line_road">
													<option value="让林路">让林路</option>
													<option value="让林路">东环路</option>
													<option value="让林路">西环路</option>
											</select><input type="text" class="span1 m-wrap" name="line_num" />号路
												<select class="span3 m-wrap" name="line_direct">
													<option value="东面">东面</option>
													<option value="西面">西面</option>
											</select><input type="text" class="span1 m-wrap" name="line_distance" />米<select
												class="span2 m-wrap" name="line_position">
													<option value="南">南</option>
													<option value="北">北</option>
											</select></td>
											<td><label>施工设备</label></td>
											<td><select class="span12 m-wrap"
												data-placeholder="选择施工设备" tabindex="1" name="device">
													<option value="吊车">吊车</option>
													<option value="履带式吊车">履带式吊车</option>
													<option value="挖沟机">挖沟机</option>
													<option value="胶轮式挖掘机">胶轮式挖掘机</option>
													<option value="轮式挖掘装改机">轮式挖掘装改机</option>
													<option value="举升车">举升车</option>
													<option value="压风机车">压风机车</option>
													<option value="平板拖车">平板拖车</option>
													<option value="卡车">卡车</option>
													<option value="面包车">面包车</option>
													<option value="自卸货车">自卸货车</option>
													<option value="计量车">计量车</option>
													<option value="擦车">擦车</option>
													<option value="油水罐车">油水罐车</option>
													<option value="绿化水罐车">绿化水罐车</option>
													<option value="热洗清蜡车">热洗清蜡车</option>
													<option value="其它">其它</option>

											</select></td>
											<td><label>否定班组</label></td>
											<td><input type="checkbox" class="group-checkable"
												value="一班" name="notTeam">一班 <input type="checkbox"
												class="group-checkable" value="二班" name="notTeam">二班
												<input type="checkbox" class="group-checkable" value="三班"
												name="notTeam">三班 <input type="checkbox"
												class="group-checkable" value="四班" name="notTeam">四班</td>
										</tr>
										<tr>
										...
										<tr class="">
											<td colspan="3" class="span6 m-wrap"><textarea
													class="span12 m-wrap" rows="3" name="description"></textarea></td>
										...
										<tr>
											...
											<td colspan="2">
												<table style="width: 100%; valign: top">
													...
													<tr>
														<td><textarea rows="5" class="span12 m-wrap"
